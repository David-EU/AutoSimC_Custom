...
class settings():
    ...
    simc_path = r'C:\\AutoSimC\\auto_download\\simc-730-03-win64\\simc.exe'
    ...
    # standard-input
    default_inputFileName = "input_compare.txt"

    # standard-output
    default_outputFileName = "out_compare.simc"
    ...
    default_fightstyle = "LightMovement"
    ...
    # ----------------------------------------------------------------------
    skip_questions = True #default: False

    # automation of dialogs
    # 1 or 2
    auto_choose_static_or_dynamic = 1 #default: 2
